...
def main():
  ...
  if opts.is_train:
    ...
    val_dataset = dataset_fn(path_cfg.name_file['val1'],
      path_cfg.attn_ft_files['val1'], path_cfg.word2int_file, model_cfg.max_words_in_sent,
      model_cfg.num_verbs, model_cfg.num_nouns,
      path_cfg.ref_caption_file['val1'], path_cfg.ref_graph_file['val1'],
