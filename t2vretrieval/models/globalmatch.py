...
import t2vretrieval.models.loss
...
class GlobalMatchModel(framework.modelbase.ModelBase):
  ...
  def build_loss(self):
    criterion = t2vretrieval.models.loss.ContrastiveLoss(
  ...
  def calculate_metrics(self, scores, i2t_gts, t2i_gts):
    # caption retrieval
    cr1, cr5, cr10, cr50, cmedr, cmeanr = t2vretrieval.models.evaluation.eval_q2m(scores, i2t_gts)
    # image retrieval
    ir1, ir5, ir10, ir50, imedr, imeanr = t2vretrieval.models.evaluation.eval_q2m(scores.T, t2i_gts)
    # sum of recalls to be used for early stopping
    rsum = cr1 + cr5 + cr10 + cr50 + ir1 + ir5 + ir10 + ir50
